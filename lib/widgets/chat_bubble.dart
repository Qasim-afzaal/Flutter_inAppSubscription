...
//   ChatBubble({super.key, required this.chatItem, this.regenerate});
...
//                         if (chatItem.headline != null ||
//                             chatItem.isSparkdLine) ...[
//                           /*Assets.icons.thumbDown.svg().paddingAll(8),*/
//                           GestureDetector(
//                               onTap: regenerate,
//                               child: Assets.icons.restartAgain
//                                   .svg()
//                                   .paddingAll(8).marginOnly(bottom: 2)),
//                         ],
//                       ],
//                     ).marginOnly(
