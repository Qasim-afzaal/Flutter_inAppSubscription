...
import 'package:flutter_inappsubscriptions/api_repository/loading.dart';
    ...
    switch (error.type) {
      ...
      case DioErrorType.unknown:
        if (error.message!.contains("SocketException")) {
          errorEntity(code: -5, message: "Your internet is not available, please try again later");
        } else if (error.message!.contains("Software caused connection abort")) {
          errorEntity(code: -6, message: "Your internet is not available, please try again later");
        }
